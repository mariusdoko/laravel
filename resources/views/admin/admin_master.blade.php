...
<head>
    ...
    <title>Letsweb - Admin Dashboard</title>
    ...
    <div class="page-wrapper">
                ...
                <div class="navbar-right ">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="github-link mr-3">
                            <a class="btn btn-outline-secondary btn-sm" href="https://github.com/mariusdoko/laravel/tree/master" target="_blank">
        ...
        <footer class="footer mt-auto">
            <div class="copyright bg-white">
                <p>
                    &copy; <span id="copy-year">2021</span> Copyright Letsweb Dashboard by
                    <a
                        class="text-primary"
                        href="http://www.letsweb.org/"
                        target="_blank"
                    >Marius</a>.
                </p>
            </div>
