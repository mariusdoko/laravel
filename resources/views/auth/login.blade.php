...
<div class="container d-flex flex-column justify-content-between vh-100">
                ...
                <div class="card-header bg-primary">
                    <div class="app-brand">
                        <a href="/index.html">
                            ...
                            <span class="brand-name">Letsweb Dashboard</span>
                        </a>
                    </div>
                </div>
    ...
    <div class="copyright pl-0">
        <p class="text-center">&copy; 2021 Copyright Letsweb Dashboard
            <a class="text-primary" href="https://www.letsweb.org/" target="_blank">Marius</a>.
        </p>
    </div>
</div>
</body>
